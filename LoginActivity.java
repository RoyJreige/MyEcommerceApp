...
public class LoginActivity extends AppCompatActivity
{
    ...
    {
        Long phone = Long.valueOf(InputPhoneNumber.getText().toString());
    ...
    private void AllowAccessToAccount(final Long phone, final String password)
    {
        ...
        RootRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            {
                if (dataSnapshot.child(parentDbName).child(String.valueOf(phone)).exists())
                {
                    Users usersData = dataSnapshot.child(parentDbName).child(String.valueOf(phone)).getValue(Users.class);
